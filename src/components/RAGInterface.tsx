    ...
    <SidebarProvider>
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 flex w-full">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          {uploadedFiles.length > 0 && (
            <div className="border-b border-slate-700/50 bg-slate-900/30 backdrop-blur-sm p-3 sm:p-4">
              <div className="max-w-full sm:max-w-4xl mx-auto">
                <h3 className="text-xs sm:text-sm font-medium text-slate-300 mb-2 sm:mb-3">
                  Uploaded Documents
                </h3>
                  ...
                  {featureButtons.map(({ id, label, icon: Icon }) => (
                    ...
                    >
                      ...
                      <span className="sm:hidden">
                        {id === "similar" ? "Similar" : id === "analyze" ? "Analyze" : "Resolve"}
                      </span>
                    </Button>
                  ))}
                </div>
